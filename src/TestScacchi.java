...
Scacchiera s=new Scacchiera(true);
	...
	public void testMove() {
		...
		Assert.assertFalse(scacchiera.mossa((Pedina)scacchiera.griglia[2][1], scacchiera.griglia[2][2]));
		Assert.assertTrue(scacchiera.mossa((Pedina)scacchiera.griglia[6][2], scacchiera.griglia[5][2]));
		Assert.assertFalse(scacchiera.mossa((Pedina)scacchiera.griglia[1][2], scacchiera.griglia[5][2]));
		Assert.assertTrue(scacchiera.mossa((Pedina)scacchiera.griglia[1][2], scacchiera.griglia[2][2]));
	}
